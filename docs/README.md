...
- Score
- Text based entities with graphics

## Planned Features

Only the leaderboard was not implemented
...
Despite a late and bumpy start the project improved fast. Tested throughly ( with the exception of getters and setters ) our project is now a playable game with a very decent amount of fearures
